...
export async function supabaseFetch(path, options = {}) {
  ...
  if (!response.ok) {
    ...
    console.error('ITBMO Supabase REST error', {
      path,
  ...
  try {
    ...
    console.error('ITBMO Supabase invalid JSON response', {
      path,
      response: text
    });

    const parseError = new Error('SUPABASE_INVALID_JSON');
    parseError.code = 'SUPABASE_INVALID_JSON';
    throw parseError;
  }
}
