// /api/chat.js — v52.1 (ESM, Vercel)
// Basado EXACTO en tu v51.2 + robustez operativa para que INFO entregue city_day válido y tabla-ready.
...
- Si se incluyen, deben ser específicas (no "restaurante local") y con horarios realistas
  (cena ~19:00–21:30). Nunca rellenes huecos con comidas.
...
- Solo si es imposible estimar con seguridad:
  "Verificar duración en el Info Chat"
...
- Si dudas de algún dato puntual, usa "Verificar ..." SOLO en duration (no en activity/from/to/transport/start/end).
...
- Comidas: SOLO si aportan valor y SIEMPRE específicas.
