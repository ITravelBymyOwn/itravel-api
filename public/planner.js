/* =========================================================
   ...
   - Conserva toda la lógica de v49 (21 secciones).
========================================================= */
...
let session = [];                // historial para el agente
let activeCity = null;
...
function intentFromText(text){
  ...
  // Cualquier tema de viajes (GLOBAL): clima, visados, seguridad, presupuesto, etc.
